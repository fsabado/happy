...
export class ApiClient {
   ...
   */
  async registerVendorToken(vendor: 'openai' | 'anthropic' | 'gemini' | 'zhipu' | 'openrouter', apiKey: any): Promise<void> {
    try {
      const response = await axios.post(
   ...
   */
  async getVendorToken(vendor: 'openai' | 'anthropic' | 'gemini' | 'zhipu' | 'openrouter'): Promise<any | null> {
    try {
